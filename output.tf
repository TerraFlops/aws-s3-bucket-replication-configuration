...
output "replication_source_policy" {
  description = "The replication policy that needs to be applied to the source bucket in the replication pair"
  value = data.aws_iam_policy_document.replication_source.json
}
